...
var FLAGS = {
  "Feb 26": [
    ...
    {"status":"monitor","title":"Non-project material purchases — $6,135 (invoicing in progress)","desc":"Various material purchases not yet billed. Stanley has already started invoicing the client and will provide an update soon.","next":"Monitor until Stanley confirms all invoiced","dept":"Revenue / D5"},
    ...
    {"status":"resolved","title":"HMCBLD01 & MLWGRP01 cloud revenue increase — explained","desc":"HMCBLD01 is a one-time income item. MLWGRP01 relates to Adobe annual renewal fees. Combined $6,697 increase.","next":"Resolved — HMCBLD01 will not recur; MLWGRP01 is annual","dept":"Revenue / D3"},
    {"status":"action","title":"Month-on-month Project P&L review needed","desc":"Need to prepare MoM Project P&L report for every project comparing actual hours vs project agreement. Will identify over-allocation and drive corrective action — either revise internal hours or request client change orders.","next":"Build MoM project P&L comparison report","dept":"COGS / D2"},
    {"status":"resolved","title":"WHIDCA01 CxO overage — one-time","desc":"Excess CxO consulting hours billed to WHIDCA01 in February. Confirmed as a one-time occurrence, not expected to recur.","next":"Resolved — one-time overage","dept":"Revenue / D6"}
  ],
  "Jan 26": [
